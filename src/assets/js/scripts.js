    ...
    if ($particles_bg.exists()) {
      $particles_bg.each(function () {
        var $self = $(this),
          ...
          _pt_base_op = $self.data("pt-base-op") ? parseFloat($self.data("pt-base-op")) : 0.1,
          _pt_shape = $self.data("pt-shape") ? $self.data("pt-shape") : "#fff",
          _pt_shape_op = $self.data("pt-shape-op") ? parseFloat($self.data("pt-shape-op")) : 0.1,
          _pt_line = $self.data("pt-line") ? $self.data("pt-line") : "#fff",
          _pt_line_op = $self.data("pt-line-op") ? parseFloat($self.data("pt-line-op")) : 0.2;
